package py.blog.admin.service;

import py.blog.admin.dao.SysMenuDao;
...
import py.blog.base.service.BaseService;
...
public class SysMenuService<T> extends BaseService<T> {
	...
	public void adds(SysMenu menu) throws Exception {
		super.add((T)menu);
	...
	public void updates(SysMenu menu) throws Exception {
		super.update((T)menu);
		saveBtns(menu.getId(),menu.getBtns());
	}
