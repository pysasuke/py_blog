...
import py.blog.admin.page.SysMenuModel;
...
import py.blog.base.util.HtmlUtil;
import py.blog.base.util.TreeUtil;
...
public class SysMenuAction extends BaseAction{
	...
	public void save(SysMenu bean, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		if(bean.getId() == null){
			...
			sysMenuService.adds(bean);
		}else{
			sysMenuService.updates(bean);
		}
